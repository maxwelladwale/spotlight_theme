    ...
    <footer id="colophon" class="bg-brand-950 text-white" role="contentinfo">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
                ...
                <!-- Newsletter -->
                <div class="col-span-2 md:col-span-1">
                    <h4 class="font-semibold text-sm mb-2"><?php esc_html_e('Subscribe to our newsletter', 'spotlight'); ?></h4>
                    <p class="text-white/40 text-xs mb-3"><?php esc_html_e('For product announcements and exclusive insights', 'spotlight'); ?></p>
                    <form class="flex gap-2" onsubmit="return false;">
                        <input type="email"
                               placeholder="<?php esc_attr_e('Input your email', 'spotlight'); ?>"
                               class="flex-1 bg-white/10 border border-white/20 rounded px-3 py-2 text-sm text-white placeholder-white/40 focus:outline-none focus:border-accent min-w-0">
                        <button type="submit" class="bg-accent hover:bg-accent-dark text-white text-sm font-semibold px-4 py-2 rounded transition-colors whitespace-nowrap">
                            <?php esc_html_e('Subscribe', 'spotlight'); ?>
                        </button>
                    </form>
                </div>
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    <a href="#" class="text-white/40 hover:text-white transition-colors" aria-label="Twitter">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/></svg>
                    </a>
                    <a href="#" class="text-white/40 hover:text-white transition-colors" aria-label="Facebook">
                    ...
                    <a href="#" class="text-white/40 hover:text-white transition-colors" aria-label="LinkedIn">
